...
def VoxtralVLLMPluginConfig(
    ...
    server_url:str='http://localhost:8000', server_port:int=8000, gpu_memory_utilization:float=0.85, max_model_len:int=32768,
    language:Optional='en', temperature:float=0.0, streaming:bool=False, server_startup_timeout:int=120,
    auto_start_server:bool=True, capture_server_logs:bool=True, dtype:str='auto', tensor_parallel_size:int=1
)->None:
